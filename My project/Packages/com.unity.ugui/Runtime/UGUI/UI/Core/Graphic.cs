...
namespace UnityEngine.UI
{
          ...
          ICanvasElement
    {
        ...
        [NonSerialized] private ShapeSoftMaskContext m_ShapeSoftMaskContext;
...
#pragma warning restore 618
        ...
        public virtual Material materialForRendering
        {
            get
            {
                ...
                return GetShapeSoftMaskMaterial(currentMat);
            }
        }

        protected Material GetShapeSoftMaskMaterial(Material baseMaterial)
        {
            if (m_ShapeSoftMaskContext == null)
                m_ShapeSoftMaskContext = ShapeSoftMasking.Acquire(transform);
            return m_ShapeSoftMaskContext.GetModifiedMaterial(baseMaterial, this);
        }

        protected void ReleaseShapeSoftMaskContext()
        {
            if (m_ShapeSoftMaskContext == null) return;
            m_ShapeSoftMaskContext.Dispose();
            m_ShapeSoftMaskContext = null;
        }

        internal void InvalidateShapeSoftMaskContext()
        {
            ReleaseShapeSoftMaskContext();
        }
